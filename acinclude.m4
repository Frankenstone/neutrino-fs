...
AC_ARG_WITH(boxtype,
	AS_HELP_STRING([--with-boxtype], [valid values: tripledragon, coolstream, spark, generic, armbox, duckbox, spark7162, mipsbox]),
	[case "${withval}" in
...
case "$BOXMODEL" in
	bre2ze4k|hd51|vusolo4k|vuduo4k|vuduo4kse|vuultimo4k|vuzero4k|vuuno4kse|vuuno4k|vuduo|h7|osmio4k|osmio4kplus)
